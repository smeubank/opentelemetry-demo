...
const Checkout: NextPage = () => {
  ...
  const { orderId, items = [], shippingAddress = { streetAddress: '', city: '', state: '', country: '', zipCode: '' }, shippingCost = { units: 0, currencyCode: 'USD', nanos: 0 } } = JSON.parse((query.order || '{}') as string) as IProductCheckout;
